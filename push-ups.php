...
<body>
	...
	<div class="container">
        <br>
		<h1 id="make">PUSH UPS</h1>
        <p>Push Ups build the chest anywhere, anytime. You can vary the position to load the chest or triceps more.</p>
        <a href="exercises.php" data-nav-link="">Another Exercises</a>
        <h3>Instructions</h3>
        <p><b>Step 1 : Begin</b> on the ground with your arms and legs straight</p>
        <p><b>Step 2 : Position</b> your hands at shoulder-width</p>
        <img src="pic/pu1.jpg" class="steps" alt="step2" width="400" height="500">
        <p><b>Step 3 : Lower</b> yourself to the ground, keeping your core engaged</p>
        <img src="pic/pu2.jpg" class="steps" alt="step3" width="400" height="500">
        <p><b>Step 4 : Press</b> into the ground until your arms are straight</p>
        <img src="pic/pu3.jpg" class="steps" alt="step4" width="400" height="500">
        <br>
        <h3>Reps By Weight</h3>
        <img src="pic/putable.png" class="steps" alt="table">
        <h3 class="mt-5 mb-3 text-center text-primary">How many calories did I burn by pushing ups ?</h2>
