...
<body>
	...
	<div class="container">
        <br>
		<h1 id="make">DUMBBELL CURL</h1>
        <p>Shoulder Press strength standards help you to compare your one-rep max lift with other lifters at your bodyweight.</p>
        <a href="exercises.php" data-nav-link="">Another Exercises</a>
        <h3>Instructions</h3>
        <p><b>Step 1 : Begin </b> with two dumbbells by your side</p>
        <img src="pic/dc1.jpg" class="steps" alt="step3" width="400" height="500">
        <p><b>Step 2 : Contract </b> your first bicep and lift the dumbbell to upper chest height</p>
        <p><b>Step 3 : Turn </b> your wrist while lifting so that your inside hand faces you</p>
        <img src="pic/dc2.jpg" class="steps" alt="step3" width="400" height="500">
        <p><b>Step 4 : Lower </b> the dumbbell back down</p>
        <img src="pic/dc3.jpg" class="steps" alt="step3" width="400" height="500">
        <p><b>Step 5 : Repeat </b> with your other arm</p>
        <img src="pic/dc4.jpg" class="steps" alt="step3" width="400" height="500">
        <p><b>Step 6 : Lower </b> the dumbbell back down to complete the repetition</p>
        <img src="pic/dc5.jpg" class="steps" alt="step3" width="400" height="500">
        <br>
        <h3>Reps By Weight</h3>
        <img src="pic/dctable.png" class="steps" alt="table">
        <h3 class="mt-5 mb-3 text-center text-primary">How many calories did I burn by dumbbell curling ?</h2>
