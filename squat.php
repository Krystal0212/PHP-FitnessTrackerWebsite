...
<body>
	...
	<div class="container">
        <br>
		<h1 id="make">SQUAT</h1>
        <p>Squat strength standards help you to compare your one-rep max lift with other lifters at your bodyweight.</p>
        <a href="exercises.php" data-nav-link="">Another Exercises</a>
        <h3>Instructions</h3>
        <p><b>Step 1 : Grip </b> the barbell and stand up to lift it off the rack</p>
        <p><b>Step 2 : Step </b> back with each leg until you are clear of the rack, setting up your footing for the lift</p>
        <img src="pic/sq1.jpg" class="steps" alt="step2" width="400" height="500">
        <p><b>Step 3 : Lower </b> yourself until your thighs are at most parallel to the floor</p>
        <img src="pic/sq2.jpg" class="steps" alt="step3" width="400" height="500">
        <p><b>Step 4 : Raise </b> yourself back up to standing</p>
        <img src="pic/sq3.jpg" class="steps" alt="step3" width="400" height="500">
        <p><b>Step 5 : Step </b> forward to rerack the barbell</p>
        <br>
        <h3>Reps By Weight</h3>
        <img src="pic/sqtable.png" class="steps" alt="table">
        <h3 class="mt-5 mb-3 text-center text-primary">How many calories did I burn by doing squat ?</h2>
