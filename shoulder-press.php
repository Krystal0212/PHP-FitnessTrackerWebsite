...
<body>
	...
	<div class="container">
        ...
        <h3>Instructions</h3>
        <p><b>Step 1 : Begin </b> with the barbell on a rack at shoulder height</p>
        <p><b>Step 2 : Lift </b> the barbell off the rack and hold it at neck height</p>
        <img src="pic/sp1.jpg" class="steps" alt="step3" width="400" height="500">
        <p><b>Step 3 : Press </b> the bar overhead</p>
        <img src="pic/sp2.jpg" class="steps" alt="step3" width="400" height="500">
        <p><b>Step 4 : Lower </b> the bar to neck height and repeat</p>
        <img src="pic/sp3.jpg" class="steps" alt="step3" width="400" height="500">
        <br>
        <h3>Reps By Weight</h3>
        <img src="pic/sptable.png" class="steps" alt="table">
        <h3 class="mt-5 mb-3 text-center text-primary">How many calories did I burn by shoulder pressing ?</h2>
