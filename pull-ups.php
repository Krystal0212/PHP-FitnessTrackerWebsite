...
<body>
	...
	<div class="container">
        <br>
		<h1 id="make">PULL UPS</h1>
        <p>Pull Ups strength standards help you to compare your one-rep max lift with other lifters at your bodyweight.</p>
        <a href="exercises.php" data-nav-link="">Another Exercises</a>
        <h3>Instructions</h3>
        <p><b>Step 1 : Grab</b> the bar with both hands wider than shoulder-width, you may need to jump or use a step</p>
        <img src="pic/pul1.jpg" class="steps" alt="step2" width="400" height="500">
        <p><b>Step 2 : Pull</b> yourself up with your back and biceps</p>
        <img src="pic/pul2.jpg" class="steps" alt="step2" width="400" height="500">
        <p><b>Step 3 : Lower</b> yourself back down carefully</p>
        <img src="pic/pul3.jpg" class="steps" alt="step3" width="400" height="500">
        <br>
        <h3>Reps By Weight</h3>
        <img src="pic/pultable.png" class="steps" alt="table">
        <h3 class="mt-5 mb-3 text-center text-primary">How many calories did I burn by pulling ups ?</h2>
